//This code sets up a potentiometer and RGB LED to switch between states.
//The idea behind the name comes from a luminecent sting ray in the ocean 
//that has its potentiometer tail moved by the changing current 
