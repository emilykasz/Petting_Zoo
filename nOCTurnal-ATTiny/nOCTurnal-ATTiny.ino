//This code uses a photoresistor to control neopixels 
//The name comes from an octapus that dosn't like light so it gets 
//red eyes (mad) by light and blue eyes (happy) in darkness
